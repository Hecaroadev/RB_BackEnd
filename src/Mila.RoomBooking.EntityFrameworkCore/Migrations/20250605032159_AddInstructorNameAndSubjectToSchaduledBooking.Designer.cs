...
namespace Mila.RoomBooking.Migrations
{
    ...
    [Migration("20250605032159_AddInstructorNameAndSubjectToSchaduledBooking")]
    partial class AddInstructorNameAndSubjectToSchaduledBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mila.RoomBooking.SchaduledBookings.SchaduledBooking", b =>
                {
                    ...
                    b.HasIndex("RoomId", "DayId", "Status")
                        .HasDatabaseName("IX_SchaduledBookings_RoomDayStatus");

                    b.ToTable("SchaduledBookings", (string)null);
                });

            modelBuilder.Entity("SchaduledBookingTimeSlots", b =>
                {
                    ...
                    b.HasKey("SchaduledBookingId", "TimeSlotId");

                    b.HasIndex("TimeSlotId");

                    b.ToTable("SchaduledBookingTimeSlots");
                });
            ...
            modelBuilder.Entity("UniversityBooking.Rooms.AvailabilityAnnouncement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AvailableTools")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("AvailabilityAnnouncements", (string)null);
                });

            modelBuilder.Entity("UniversityBooking.Rooms.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchaduledBookingTimeSlots", b =>
                {
                    ...
                    b.HasOne("UniversityBooking.TimeSlots.TimeSlot", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniversityBooking.BookingRequests.BookingRequest", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "RequestedByUser")
                        .WithMany()
                    ...
                    b.HasOne("UniversityBooking.Rooms.Room", null)
            ...
            modelBuilder.Entity("UniversityBooking.Bookings.Booking", b =>
                {
                    b.HasOne("UniversityBooking.BookingRequests.BookingRequest", "BookingRequest")
                        .WithMany()
